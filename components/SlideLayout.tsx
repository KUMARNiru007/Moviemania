...
export const SlideLayout: React.FC<SlideLayoutProps> = ({
  ...
  return (
    <motion.div
      className={`absolute inset-0 w-full h-full flex flex-col items-center justify-center overflow-hidden transition-colors ${
    ...
    >
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center px-6 py-12">
